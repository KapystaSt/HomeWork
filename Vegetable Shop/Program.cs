    ...
    class VegetableShop
    {
        ...
        public void PrintProductsInfo()
        {
            ...
            foreach (var product in products)
            {
                ...
                {
                    Console.WriteLine($"Product: {potato.Name}, Count: {potato.Count}, Total price: {potato.GetPrice()}");
                }
                else if (product is Cucumber cucumber)
                {
                    Console.WriteLine($"Product: {cucumber.Name}, Count: {cucumber.Count}, Total price: {cucumber.GetPrice()}");
                }
                else
                {
